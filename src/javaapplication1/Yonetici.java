...
public class Yonetici extends Kullanici{
    ...
    public Yonetici(String tckno, String sifre, String isim, String soyisim){
        this.isim= isim;
        this.sifre=sifre;
        this.soyisim=soyisim;
        this.tckno=tckno;
    }
    public Yonetici(String tckno, double bakiye, boolean onay, double kredikartiborc){
        this.tckno= tckno;
        this.bakiye= bakiye;
        this.onay=onay;
    ...
    public void hesapsil() {
        ...
        try{
            ...
            pstatement= con.prepareStatement("DELETE FROM YONETICIOZLUKBILGILERI WHERE TCKNO=? ");
            pstatement.setString(1, tckno);
            pstatement.executeUpdate();
    ...
    public void hesapolustur() {
        ...
        try{
            pstatement= con.prepareStatement("insert into YONECITIBANKABILGILERI(TCKNO, BAKIYE, KREDIONAYDURUMU, KREDIKARTIBORC) values (?,?,?,?) ");
            pstatement.setString(1, tckno);
    ...
    public void bankabilgisihesapsil() {
        ...
        try{
            ...
            pstatement= con.prepareStatement("DELETE FROM YONECITIBANKABILGILERI WHERE TCKNO=? ");
            pstatement.setString(1, tckno);
            pstatement.executeUpdate();
    ...
    public void bakiyevekkborcgetir() {
        try{
            pstatement=con.prepareStatement("select BAKIYE, KREDIKARTIBORC from YONECITIBANKABILGILERI where TCKNO= ?");
            pstatement.setString(1, tckno);
    ...
    public void adsoyadgetir() {
        try{
            pstatement=con.prepareStatement("select ISIM, SOYISIM from YONETICIOZLUKBILGILERI where TCKNO= ?");
            pstatement.setString(1, tckno);
            rset= pstatement.executeQuery();
            if(rset.next()){
    ...
    public void paracek(double sayi) {
        try {
            pstatement= con.prepareStatement("update YONECITIBANKABILGILERI set BAKIYE= BAKIYE- ? where TCKNO=?");
    ...
    public void kredionaylama() {
        ...
        try {
            pstatement= con.prepareStatement("update YONECITIBANKABILGILERI set KREDIONAYDURUMU=? where TCKNO=?");
            pstatement.setString(2, tckno);
            ...
            else if(bakiye-kredikartiborc<1000){
    ...
    public void kredionaydurumu() {
         try{
            pstatement=con.prepareStatement("select KREDIONAYDURUMU from YONECITIBANKABILGILERI where TCKNO= ?");
            pstatement.setString(1, tckno);
            rset= pstatement.executeQuery();
            if(rset.next()){
